...
void UTitleWidget::NativeConstruct()
{
	...
	StartServerButton->OnClicked.AddDynamic(this , &UTitleWidget::StartSever);
	ConnectButton->OnClicked.AddDynamic(this, &UTitleWidget::Connect);
}

void UTitleWidget::StartSever()
{
	SaveData();
	UGameplayStatics::OpenLevel(GetWorld(), TEXT("Lvl_Lobby"), true, TEXT("listen"));
}
